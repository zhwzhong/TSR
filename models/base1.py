...
class PBVS(nn.Module):
    def __init__(self, embed_dim):
        ...
        self.head = nn.Sequential(
            ConvBNReLU2D(1, out_channels=embed_dim, kernel_size=7, act='PReLU', padding=3),
...
class NIR(nn.Module):
    def __init__(self):
        ...
        self.rgb = ConvBNReLU2D(3, out_channels=3, kernel_size=7, act='PReLU', padding=3, bias=False)
        self.nir = ConvBNReLU2D(1, out_channels=3, kernel_size=7, act='PReLU', padding=3, bias=False)
        self.fuse = ConvBNReLU2D(6, out_channels=3, kernel_size=7, act='PReLU', padding=3, bias=False)
...
class Net(nn.Module):
    def __init__(self, args):
        ...
        self.tail = ConvBNReLU2D(in_channels=args.embed_dim, out_channels=1, kernel_size=7, padding=3, bias=False)
        if args.pre_trained:
